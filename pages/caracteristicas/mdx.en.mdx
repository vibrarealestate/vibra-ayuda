...
With Vibra, all your `.md` and `.mdx` files under the pages directory will be rendered with [MDX](https://mdxjs.com/about), it's an
...
```markdown
> <Callout>
>   Give [**Vibra**](https://github.com/vibrarealestate/vibra-ayuda) a star!
> </Callout>
```
