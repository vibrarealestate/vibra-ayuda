...
You can also use a `meta.json` file to config the order and displayed name of the page ([example](https://github.com/vibrarealestate/vibra-ayuda/blob/master/pages/meta.json)).
